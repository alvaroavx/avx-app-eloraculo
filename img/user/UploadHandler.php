...
class UploadHandler
{
    ...
    public function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        $this->options = array(
            ...
            'inline_file_types' => '/^image\/(gif|jpe?g|png)$/i',
    ...
    protected function handle_file_upload($uploaded_file, $name, $size, $type, $error,
        ...
        $temptexto = $this->get_file_name($uploaded_file, $name, $size, $type, $error,
            $index, $content_range);

        $temptexto = str_replace($no_permitidas, $permitidas ,$temptexto);
