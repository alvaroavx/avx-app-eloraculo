...
class UploadHandler
{
    ...
    protected $error_messages = array(
        ...
        'post_max_size' => 'El archivo supere el limite de tamaño definido',
        'max_file_size' => 'File is too big',
        'min_file_size' => 'File is too small',
        'accept_file_types' => 'Formato de archivo no permitido',
        'max_number_of_files' => 'Numero maximo de archivos superado',
        'max_width' => 'Image exceeds maximum width',
        'min_width' => 'Image requires a minimum width',
        'max_height' => 'Image exceeds maximum height',
        'min_height' => 'Image requires a minimum height',
        'abort' => 'La carga ha sido abortada',
    ...
    protected function handle_file_upload($uploaded_file, $name, $size, $type, $error,
        ...
        $temptexto =  $this->get_file_name($uploaded_file, $name, $size, $type, $error,$index, $content_range);

        $file->name = strtolower(str_replace($no_permitidas, $permitidas ,$temptexto));
        /**NJONG TOUCH**/
    ...
    public function post($print_response = true) {
        ...
        /**NJONG TOUCH**/
        $file_name =  (($this->options['file_name'] != '')? $this->options['file_name']: null);
        /**NJONG TOUCH**/
            ...
            if (is_array($upload['tmp_name'])) {
                ...
                foreach ($upload['tmp_name'] as $index => $value) {
                    $files[] = $this->handle_file_upload(
                        ...
                        $file_name ? $file_name.substr($upload['name'][$index], strrpos($upload['name'][$index], '.'))
                            : $upload['name'][$index],
